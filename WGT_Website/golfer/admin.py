...
class GolferRoundScoresAdmin (admin.ModelAdmin):
    ...
    exclude = ['grs_id']
    actions_on_top = False
    fieldsets = [(None, {'fields': ['grs_tourn_golfer']}), (None, {'fields': [('grs_total_score', 'grs_round')]}), ('Scores (Front nine)', {'fields': [('grs_hole1_score',  'grs_hole2_score', 'grs_hole3_score', 'grs_hole4_score', 'grs_hole5_score', 'grs_hole6_score', 'grs_hole7_score', 'grs_hole8_score', 'grs_hole9_score')]}), ('Scores (Back nine)', {'fields':  [('grs_hole10_score', 'grs_hole11_score', 'grs_hole12_score', 'grs_hole13_score', 'grs_hole14_score', 'grs_hole15_score', 'grs_hole16_score', 'grs_hole17_score', 'grs_hole18_score')]})]
